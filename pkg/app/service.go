...
type AppService interface {
	...
	GetAllApps(teamID int) ([]AppDto, error)
	DuplicateApp(teamID int, appID, userID int, name string) (AppDto, error)
	ReleaseApp(teamID int, appID int) (int, error)
	GetMegaData(teamID int, appID int, version int) (Editor, error)
}
...
func (impl *AppServiceImpl) GetAllApps(teamID int) ([]AppDto, error) {
...
func (impl *AppServiceImpl) GetMegaData(teamID, appID, version int) (Editor, error) {
