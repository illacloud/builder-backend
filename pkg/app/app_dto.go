...
func (appd *AppDto) UpdateAppDtoByConfigAppRawRequest(rawReq map[string]interface{}) error {
	var assertPass bool
	for key, value := range rawReq {
		switch key {
		case APPD_FIELD_NAME:
			appd.Name, assertPass = value.(string)
			if !assertPass {
