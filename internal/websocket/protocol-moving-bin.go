...
type MovingMessageBin struct {
	...
	X                 float32 `protobuf:"fixed32,10,opt,name=x,proto3" json:"x,omitempty"`                              // instance x, by illa ubilder canvas dot
	Y                 float32 `protobuf:"fixed32,11,opt,name=y,proto3" json:"y,omitempty"`                              // instance y, by illa ubilder canvas dot
	W                 uint32  `protobuf:"varint,12,opt,name=w,proto3" json:"w,omitempty"`                               // instance w, by illa ubilder canvas dot
	H                 uint32  `protobuf:"varint,13,opt,name=h,proto3" json:"h,omitempty"`                               // instance h, by illa ubilder canvas dot
}
...
func (x *MovingMessageBin) GetX() float32 {
	if x != nil {
		return x.X
	}
	return 0
...
func (x *MovingMessageBin) GetY() float32 {
	if x != nil {
		return x.Y
	}
	return 0
...
var file_cursor_sync_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x08, 0x74, 0x75, 0x74, 0x6f, 0x72, 0x69, 0x61, 0x6c, 0x22, 0xfe, 0x02,
	...
	0x79, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x12, 0x0c, 0x0a, 0x01, 0x78, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x02, 0x52, 0x01, 0x78, 0x12, 0x0c, 0x0a, 0x01, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x02, 0x52,
	0x01, 0x79, 0x12, 0x0c, 0x0a, 0x01, 0x77, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x77,
	0x12, 0x0c, 0x0a, 0x01, 0x68, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x68, 0x2a, 0xea,
