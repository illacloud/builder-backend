...
const (
	Target_TARGET_NOTNING            Target = 0 // placeholder for nothing
...
type MovingMessageBin struct {
	...
	Signal        Signal `protobuf:"varint,1,opt,name=signal,proto3,enum=tutorial.Signal" json:"signal,omitempty"` // see package ws const define
	Target        Target `protobuf:"varint,2,opt,name=target,proto3,enum=tutorial.Target" json:"target,omitempty"` //
	ClientD       string `protobuf:"bytes,3,opt,name=clientD,proto3" json:"clientD,omitempty"`                     // message sender websocket client ID
	...
	Status        int32  `protobuf:"varint,6,opt,name=status,proto3" json:"status,omitempty"`            // set instance to status, 0 for empty status
	DisplayNames  string `protobuf:"bytes,7,opt,name=displayNames,proto3" json:"displayNames,omitempty"` // message affected component display names, separate with comma ","
	X             uint32 `protobuf:"varint,8,opt,name=x,proto3" json:"x,omitempty"`                      // instance x, by illa ubilder canvas dot
	Y             uint32 `protobuf:"varint,9,opt,name=y,proto3" json:"y,omitempty"`                      // instance y, by illa ubilder canvas dot
	W             uint32 `protobuf:"varint,10,opt,name=w,proto3" json:"w,omitempty"`                     // instance w, by illa ubilder canvas dot
	H             uint32 `protobuf:"varint,11,opt,name=h,proto3" json:"h,omitempty"`                     // instance h, by illa ubilder canvas dot
}
...
func (x *MovingMessageBin) GetTarget() Target {
	...
	return Target_TARGET_NOTNING
}

func (x *MovingMessageBin) GetClientD() string {
	if x != nil {
		return x.ClientD
	}
	return ""
...
func (x *MovingMessageBin) GetX() uint32 {
	if x != nil {
		return x.X
	}
	return 0
...
func (x *MovingMessageBin) GetY() uint32 {
	if x != nil {
		return x.Y
	}
	return 0
...
func (x *MovingMessageBin) GetW() uint32 {
	if x != nil {
		return x.W
	}
	return 0
...
func (x *MovingMessageBin) GetH() uint32 {
	if x != nil {
		return x.H
	}
	return 0
...
var file_cursor_sync_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x08, 0x74, 0x75, 0x74, 0x6f, 0x72, 0x69, 0x61, 0x6c, 0x22, 0xb2, 0x02,
	...
	,
