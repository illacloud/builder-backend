...
const (
	...
	COMPONENTS_BASE_PROMPT_TABLE_WIDGET          = "{\"$dynamicAttrPaths\":[],\"columns\":[{\"enableSorting\":true,\"type\":\"auto\",\"visible\":true,\"format\":\"YYYY-MM-DD\",\"colorScheme\":\"blue\",\"objectFit\":\"scale-down\",\"id\":\"month\",\"header\":\"month\",\"accessorKey\":\"month\",\"columnIndex\":0},{\"enableSorting\":true,\"type\":\"auto\",\"visible\":true,\"format\":\"YYYY-MM-DD\",\"colorScheme\":\"blue\",\"objectFit\":\"scale-down\",\"id\":\"users\",\"header\":\"users\",\"accessorKey\":\"users\",\"columnIndex\":1},{\"enableSorting\":true,\"type\":\"auto\",\"visible\":true,\"format\":\"YYYY-MM-DD\",\"colorScheme\":\"blue\",\"objectFit\":\"scale-down\",\"id\":\"incomes\",\"header\":\"incomes\",\"accessorKey\":\"incomes\",\"columnIndex\":2}],\"dataSourceJS\":\"{{[\\\n  {\\\n    \\\"month\\\": \\\"April\\\",\\\n    \\\"users\\\": 3700,\\\n    \\\"incomes\\\": 4000\\\n  },\\\n  {\\\n    \\\"month\\\": \\\"May\\\",\\\n    \\\"users\\\": 5400,\\\n    \\\"incomes\\\": 8700\\\n  },\\\n  {\\\n    \\\"month\\\": \\\"June\\\",\\\n    \\\"users\\\": 6000,\\\n    \\\"incomes\\\": 12000\\\n  },\\\n  {\\\n    \\\"month\\\": \\\"July\\\",\\\n    \\\"users\\\": 8000,\\\n    \\\"incomes\\\": 14000\\\n  }\\\n]}}\",\"dataSourceMode\":\"dynamic\",\"defaultSortKey\":\"id\",\"defaultSortOrder\":\"ascend\",\"download\":false,\"emptyState\":\"Norowsfound\",\"filter\":false,\"overFlow\":\"pagination\",\"pageSize\":\"{{10}}\"}"
	...
	COMPONENTS_BASE_PROMPT_CHART_WIDGET          = "{\"dataSourceJS\":\"{{[\\\\n  {\\\\n    month: \\\"April\\\",\\\\n    users: 3700,\\\\n    incomes: 4000,\\\\n  },\\\\n  {\\\\n    month: \\\"May\\\",\\\\n    users: 5400,\\\\n    incomes: 8700,\\\\n  },\\\\n  {\\\\n    month: \\\"June\\\",\\\\n    users: 6000,\\\\n    incomes: 12000,\\\\n  },\\\\n  {\\\\n    month: \\\"July\\\",\\\\n    users: 8000,\\\\n    incomes: 14000,\\\\n  },\\\\n]}}\",\"chartType\":\"bar\",\"dataSourceMode\":\"dynamic\",\"xAxis\":\"month\",\"datasets\":[{\"id\":\"8e6fc947-f354-4e33-977d-7dd0ca85b23a\",\"datasetName\":\"Dataset1\",\"datasetValues\":\"users\",\"aggregationMethod\":\"SUM\",\"type\":\"bar\",\"color\":\"#165DFF\"}],\"$dynamicAttrPaths\":[]}"
