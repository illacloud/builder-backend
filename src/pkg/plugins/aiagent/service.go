...
import (
	...
	resourcemanager "github.com/illacloud/builder-backend/internal/util/illaresourcemanagerbackendsdk"
...
func (r *AIAgentConnector) ValidateActionOptions(actionOptions map[string]interface{}) (common.ValidateResult, error) {
