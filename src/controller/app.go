...
func (controller *Controller) DuplicateApp(c *gin.Context) {
	...
	controller.DuplicateActionByVersion(c, teamID, teamID, appID, duplicatedAppID, targetApp.ExportMainlineVersion(), model.APP_EDIT_VERSION, false, userID, false)
...
func (controller *Controller) TakeSnapshot(c *gin.Context) {
	...
	controller.DuplicateActionByVersion(c, teamID, teamID, appID, appID, model.APP_EDIT_VERSION, app.ExportMainlineVersion(), app.IsPublic(), userID, false)
...
func (controller *Controller) RecoverSnapshot(c *gin.Context) {
	...
	controller.DuplicateActionByVersion(c, teamID, teamID, appID, appID, targetVersion, model.APP_EDIT_VERSION, app.IsPublic(), userID, false)
...
func (controller *Controller) ForkMarketplaceApp(c *gin.Context) {
	...
	controller.DuplicateActionByVersion(c, app.ExportTeamID(), toTeamID, appID, duplicatedAppID, app.ExportMainlineVersion(), model.APP_EDIT_VERSION, false, userID, true)
