module github.com/illa-family/builder-backend
...
replace github.com/elastic/go-elasticsearch/v8 v8.4.0 => github.com/illa-family/go-elasticsearch/v8 v8.4.0-illa
